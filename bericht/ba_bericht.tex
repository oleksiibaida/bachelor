...
\subsection{Einrichtung der Hardwarekomponenten}
  ...
  \subsubsection{Einrichtung der ESP-Module}
  ...
  \begin{itemize}
    ...
    \item \textbf{devices} --- Speichert die vom Benutzer angemeldeten Geräte. 
                        \begin{itemize}
                          ...
                          \item \textit{\textbf{dev\_type:}} Einer von drei Gerätetypen: Lichtsensor, Temperatur-\& Luftfeuchtigkeitssensor oder Alarmsystem. Dient ausschließlich zur Anzeige von Informationen im Frontend.
                        \end{itemize}
