...
% „“
  ...
  \par Der I²C-Bus basiert auf dem Controller-Target-Prinzip (früher Master-Slave-Prinzip). Der Controller ist das Gerät, das die Datenübertragung auf dem Bus initiiert und die Taktimpulse erzeugt. Das angesprochene Gerät wird in diesem Moment als Target betrachtet. Der Bus erlaubt mehrere Controller- und Target-Geräte, wobei jedes Gerät eine eindeutige Adresse besitzt.
  \par I²C- Bus verwendet das Controller-Target-Prinzip (früher Master-Slave-Prinzip). Ein Controller ist das Gerät, das die Datenübertragung auf dem Bus initiiert und die Taktsignale erzeugt. Zu diesem Zeitpunkt wird jedes angesprochene Gerät als Ziel betrachtet. Es können mehrere Target- und Controller-Geräte am Bus angeschlossen sein, wobei jedes Gerät eine eindeutige Adresse besitzt.
  \par SDA und SCL sind bidirektionale Leitungen. Wenn der Bus frei ist, sind beide Leitungen auf \texttt{HIGH} gesetzt. Alle Transaktionen beginnen mit einer Startbedingung und enden mit einer Stopbedingung. Beide Bedingungen werden immer von dem Controller erzeugt. 
  ...
  \par Der Vorteil von I²C liegt in der einfachen Verkabelung, da nur zwei Leitungen für die Kommunikation mehrerer Geräte ausreichen. I²C wird häufig in Sensoren, Echtzeituhrmodulen, EEPROMs und Display-Controllern eingesetzt. Insbesondere in Embedded-Systemen und IoT-Anwendungen ist das Protokoll aufgrund seiner geringen Hardwareanforderungen und flexiblen Adressierung weit verbreitet.
  \subsection{Software}
